...
return new class extends Migration
{
    ...
    public function up()
    {
        $foodFreemiumPlanId = DB::table('pricing_plans')->where('short_code', 'FS-PP-01')->value('id');
        $foodFeatures = Feature::whereNotNull('feature_category')->where('feature_category', 'sport_entertainment')->get();
